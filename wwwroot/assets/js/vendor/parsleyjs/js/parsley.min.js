...
! function (e, t) {
    ...
    e.extend(!0, O, {
        ...
        type: {
            ...
            latitude: "Value should be proper latitude.",
            longitude: "Value should be proper longitude.",
            alpha: "This field should contain alphabets and space(as needed).",
            alphaspace: "This value should proper valid data `~'<>\\. not allowed",
        },
