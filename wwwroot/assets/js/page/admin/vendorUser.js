...
function loademployeelist(Vendor_Branch_Id, s,text) {
    ...
    $.ajax({
        ...
        success: function (response) {
            var data = response;
            var table = $('<table id="'+Vendor_Branch_Id+'"></table>');
            table[0].border = "0";
            table[0].style = "width:700px";
            table.append('<tr><td colspan="2" style="background-color: #ece0e0f5;font-size: 18px;color: #3c1515;">' + text + '</td></tr>');
            $(data).each(function () {
                ...
                table.append(
                    ...
                    $('<tr style="font-size: 15px"></tr>').append($('<td ></td>').append($('<input>').attr({
                    ...
                    columns: [
                        ...
                        { data: 'Vendor_Email' },
                        {
                            ...
                            render: function (data, type, row) {
                                ...
                                return '<td> <button type="button" class="btn btn-icon btn-rounded btn-outline-success" title = "Add Permission" data-vid=' + code + ' onclick="addpermissiondetails(\'' + cod + '\')" ><i class="simple-icon-pencil"></i></button></td>';
