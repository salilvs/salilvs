        ...
        if (isConfirm) {
          ...
          //  data.append("prSubCatId", value_prSubCatId)
            $.ajax({
                type: "Post",
                contentType: "application/json;charset=utf-8",
                url: "/Product/DownloadProductDetCat",
                dataType: "json",
                data: data,
                contentType: false,
                processData: false,
    ...
    swal({
        ...
        if (isConfirm) {
            ...
            $.ajax({
                type: "Post",
                contentType: "application/json;charset=utf-8",
                url: "/Product/DownloadProductDetCatSubCat",
                dataType: "json",
                data: data,
                contentType: false,
                processData: false,
...
function downloadproductdetails(Vendor_Id)
{
    ...
    data.append("Vendor_Id", Vendor_Id);
            $.ajax({
                type: "Post",
                contentType: "application/json;charset=utf-8",
                url: "/Product/DownloadProductDet",
                dataType: "json",
                data: data,
                contentType: false,
                processData: false,
...
function loadproductdetails_Avilablity(Avl) {
    ...
    $.ajax({
        ...
        url: "/Product/LoadVendorProductdet_Avilability",
        dataType: "json",
        data: data,
        contentType: false,
        processData: false,
...
function loadproductdetails_Status(Status) {
    ...
    $.ajax({
        ...
        contentType: "application/json;charset=utf-8",
        //url: "/Product/LoadVendorProducts",
        url: "/Product/LoadVendorProductdet_Status",
        dataType: "json",
        data: data,
        contentType: false,
        processData: false,
...
function loadproductdetails_SubCategory(Cat_Id,SubCat_Id) {
    ...
    $.ajax({
        ...
        contentType: "application/json;charset=utf-8",
        //url: "/Product/LoadVendorProducts",
        url: "/Product/LoadVendorProductdet_Subcategory",
        dataType: "json",
        data: data,
        contentType: false,
        processData: false,
...
function loadproductdetails_Category(Cat_Id) {
    ...
    $.ajax({
        ...
        contentType: "application/json;charset=utf-8",
        //url: "/Product/LoadVendorProducts",
        url: "/Product/LoadVendorProductdet_category",
        dataType: "json",
        data: data,
        contentType: false,
        processData: false,
...
function updateProductDet(values) {
    ...
    $.ajax({
        ...
        url: "/Product/UpdateVendor_ProductDetails",
        dataType: "json",
        data: data,
        contentType: false,
        processData: false,
...
function SaveProductOfferPrices(itco, available_qty, unit_weight, offer_pr) {
    ...
    $.ajax({
        type: "Post",
        contentType: "application/json;charset=utf-8",
        url: "/Product/SaveVendorProductOfferPrice",
        dataType: "json",
        data: data,
        contentType: false,
        processData: false,
...
function updatevendorproductdetails(itco) {
    ...
    $.ajax({
        ...
        contentType: "application/json;charset=utf-8",
        //url: "/VendorCreation/UpdateVendorDetails",
        url: "/Product/UpdateVendorProductDetails",
        dataType: "json",
        data: data,
        contentType: false,
        processData: false,
...
function loadproductdetails() {
    ...
    $.ajax({
        ...
        contentType: "application/json;charset=utf-8",
        //url: "/Product/LoadVendorProducts",
        url: "/Product/LoadVendorProductdet",
        dataType: "json",
        data: data,
        contentType: false,
        processData: false,
            ...
            if (dat.length > 0) {
                ...
                $('#tbl_productlist').DataTable({
                    ...
                    createdRow: function (row, data, dataIndex) {
                        // Set the data-status attribute, and add a class
                        $(row).find('td:eq(5)')
                            .attr('data-field', 'ItemCode');
               
                        $(row).find('td:eq(5)')
                            .attr('data-field', 'ProductName');
                        $(row).find('td:eq(6)')
                            .attr('data-field', 'ProductQty');
                        $(row).find('td:eq(6)')
                            .attr('data-field', 'ProductPrice');
                    },
                    columns: [
                        {
                            render: function (data, type, row, meta) {
