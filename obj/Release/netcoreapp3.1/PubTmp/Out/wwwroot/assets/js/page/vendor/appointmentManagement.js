$(function () {
    ...
    $('#Pending-tab').unbind().click(function () {
        var url = "../assets/js/page/vendor/appointmentManagement.js";
    ...
    $('#Confirmed-tab').unbind().click(function () {
        var url = "../assets/js/page/vendor/confirmAppointment.js";
        $.getScript(url, function () {
            console.log("Confirm Appointment loaded");
        });
    });
    $('#Approve-tab').unbind().click(function () {
        var url = "../assets/js/page/vendor/approveAppointment.js";
        $.getScript(url, function () {
            console.log("Confirm Appointment loaded");
        });
    });
    $('#CancellationRequest-tab').unbind().click(function () {
        var url = "../assets/js/page/vendor/cancellationAppointment.js";
        $.getScript(url, function () {
            console.log("Confirm Appointment loaded");
        });
    });
    $('#RescheduleRequest-tab').unbind().click(function () {
        var url = "../assets/js/page/vendor/RescheduleAppointment.js";
        $.getScript(url, function () {
            console.log("Confirm Appointment loaded");
        });
    });
    $('#Completed-tab').unbind().click(function () {
        var url = "../assets/js/page/vendor/CompleteAppointment.js";
        $.getScript(url, function () {
            console.log("Confirm Appointment loaded");
        });
    });
    $('#MissedBooking-tab').unbind().click(function () {
        var url = "../assets/js/page/vendor/MissedBookingAppointment.js";
        $.getScript(url, function () {
            console.log("Confirm Appointment loaded");
        });
    });
                    ...
                    columns: [
                        ...
                        { data: 'Package_Name' },
                        {
                            ...
                            render: function (data, type, row) {
                                ...
                                return '<td> <button type="button" class="btn btn-icon btn-rounded btn-outline-success" title = "View" onclick="viewpendingAppointmentdetails(\'' + code + '\')" ><i class="feather icon-edit"></i>View</button></td>';
