$(function () {
   ...
   // $('#image1').attr('src', "../assets/img/bookit/no-image-found-360x250.png");
    ...
    loadFranchiseDeliveryBoydetails();
    ...
    $('#btnAddNew').unbind().click(function () {
        resetFranchiseDeliveryBoy();

        $('#FranchiseDeliveryBoy-Modal').modal('show');
        $('#deliveryboytimeslot').hide();
        $('#btn_Update').hide();
        $('#btnSave').show();
        $('#chkSlotChangeId').hide();
        $('#Delboy_Id').hide();
    ...
    $('#btnClose').unbind().click(function () {
        ...
        $('#FranchiseDeliveryBoy-Modal').modal('hide');
    ...
    $('#btnSave').unbind().click(function () {
        ...
        if ($('#franchisedeliveryboyform').parsley().validate() !== true) {
    ...
    function slotChange(isChecked) {
        if (isChecked) {
            //$('#deliveryboytimeslot').show();
            $('#deliveryboytimeslot1').show();
            $('#flagId').val("1");
            var xxx = ($("#txtworkinghoursfrom1").val());
            var yyy = ($("#txtworkinghoursto1").val());
            //var  j=0;
...
function savedetails() {
    ...
    $.ajax({
        ...
        contentType: "application/json;charset=utf-8",
        //url: "/VendorProduct/saveProductcategorydetails",
        url: "/DeliveryBoy/Franchise_saveDeliveryBoyDetails",
        dataType: "json",
        data: data,
        contentType: false,
        processData: false,
...
function loadFranchiseDeliveryBoydetails() {
    $.ajax({
        type: "Post",
        contentType: "application/json;charset=utf-8",
        //url: "/DeliveryBoy/LoadDeliverBoy1",
        url: "/DeliveryBoy/LoadFranchiseDeliverBoy",
        dataType: "json",
        success: function (response) {
            var dat = response;
            if (dat.length > 0) {
                    ...
                    if (dat.length > 0) {
                      ...
                      //  $('#deliveryboytimeslot').hide();
                        ...
                        $.each(response, function (i, vari) {
                            ...
                            $('#Delboy_Id').show();
                            $('#txtDeliveryBoyId').val(vari.DeliveryBoyId);
...
function resetFranchiseDeliveryBoy() {
    imageDeliveryBoyImag();
    $('#image1').attr('src', "../assets/img/bookit/no-image-found-360x250.png");
    $('#btnUpdate').hide();
    ...
    $('#btnSave').prop('disabled', false);
    $('#btnSave').show();
    $('#franchisedeliveryboyform').parsley().reset();
    $('#franchisedeliveryboyform')[0].reset();
